...
public sealed class CharacterGridView : MonoBehaviour
{
    ...
    [Header("프리팹/루트")]
    [SerializeField] private CharacterThumbnailView cardPrefab; // 변경
    [SerializeField] private Transform contentRoot;

    private readonly List<CharacterThumbnailView> _spawned = new List<CharacterThumbnailView>(64); // 변경

    public event Action<CharacterDefinitionSO> OnClickCharacter;

    public void SetCatalog(CharacterCatalogSO newCatalog) => catalog = newCatalog;
